...
- Review aesthetic direction (bold minimal, maximalist, raw brutalist, etc.)
- Check typography and motion guidelines
...
- Aesthetics: [Specify tone] (DO NOT use generic AI styles or standard Inter/Roboto fonts)
- Motion/Micro-interactions: [CSS hover/click effects]
